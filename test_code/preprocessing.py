...
# with open('speeches_by_candidate.json','w') as outfile:
#   json.dump(speeches_by_candidate, outfile, sort_keys=True, indent=4, separators=(',', ': '))
...
ct_vectorizer.fit_transform(speeches_by_candidate)
